          ...
          >
            ...
            >
              ...
              onClick={handleScroll}
                variant="outline"
                size="lg"
                className="border-2 border-amber-400 text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/20 px-8 py-4 text-lg font-semibold backdrop-blur-sm bg-transparent dark:hover:text-white"
              >
                Watch Demo
              </Button>
            </motion.div>
