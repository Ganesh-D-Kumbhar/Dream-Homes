  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-yellow-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      >
        ...
        <div className="absolute top-10 left-10 w-72 h-72 bg-yellow-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
        <div
          className="absolute bottom-10 right-10 w-72 h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <Badge className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-6 py-2 text-sm font-semibold shadow-lg mb-6">
              <Crown className="w-4 h-4 mr-2" />
              Premium Member
            </Badge>
            <h1 className="text-4xl flex items-center justify-center gap-2 md:text-6xl font-bold mb-6 leading-tight">
              My
      ...
      <motion.section
        ...
        initial="hidden"
        animate="visible"
        className="py-12 relative -mt-10 z-10"
      >
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-4 gap-8">
            {/* Profile Sidebar */}
            <motion.div variants={itemVariants} className="lg:col-span-1">
              <Card className="border-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-lg shadow-xl sticky top-8">
                <CardContent className="p-8">
                  {/* Profile Image */}
                  <div className="text-center mb-8">
                    <div className="relative inline-block">
                      <Avatar className="w-32 h-32 border-4 border-yellow-400/30 shadow-2xl">
                        <AvatarImage src={profileImage || "/placeholder.svg?height=128&width=128"} alt={user?.name} />
                        <AvatarFallback className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white text-3xl font-bold">
                      ...
                      <Button
                        ...
                        className="absolute -bottom-2 -right-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-full h-10 w-10 shadow-lg"
                      >
                    ...
                    <h3 className="text-2xl font-bold text-slate-800 dark:text-white mt-4">{user?.name}</h3>
                    <p className="text-slate-600 dark:text-slate-400">{user?.email}</p>
                    <Badge className="bg-emerald-100 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-400 mt-2">
                    ...
                    >
                            ...
                            <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-6">
                              <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                  <Label
                                    htmlFor="name"
                                    className="text-slate-700 dark:text-slate-300 font-semibold mb-2 block"
                                  >
                                    Full Name *
                                  </Label>
                                  <div className="relative">
                                    ...
                                    <Input
                                      ...
                                      className={`pl-12 h-12 bg-slate-50 dark:bg-slate-700 border-0 focus:ring-2 focus:ring-yellow-400 rounded-xl ${
                                ...
                                <div>
                                  ...
                                  <div className="relative">
                                    ...
                                    <Input
                                      value={user?.email}
                                      disabled
                                      className="pl-12 h-12 bg-slate-100 dark:bg-slate-600 border-0 rounded-xl text-slate-500 cursor-not-allowed"
                                    />
                                  </div>
                              ...
                              <Button
                                type="submit"
                                disabled={isUpdating}
                                className="w-full md:w-auto bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white h-12 px-8 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl"
                              >
                                {isUpdating ? (
                                  <>
                      ...
                      {activeTab === "security" && (
                        <div className="space-y-8">
                          <div>
                            ...
                            <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="space-y-6">
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <Input
                                    ...
                                    className={`pl-12 pr-12 h-12 bg-slate-50 dark:bg-slate-700 border-0 focus:ring-2 focus:ring-yellow-400 rounded-xl ${
                              ...
                              <Button
                                type="submit"
                                disabled={isUpdating}
                                className="w-full md:w-auto bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white h-12 px-8 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl"
                              >
                                {isUpdating ? (
                                  <>
                                    <Loader2 className="mr-2 h-5 w-5 animate-spin" />
                          ...
                          {/* Security Info */}
                          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-2xl border border-blue-200/50 dark:border-blue-700/50">
                        ...
                        <div className="space-y-8">
                          <div>
                            ...
                            <div className="space-y-6">
                              <div className="p-6 bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-2xl">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                  ...
                                  <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-700 rounded-xl">
                                    <span className="text-slate-700 dark:text-slate-300">Advanced Filters</span>
                                    <Badge className="bg-yellow-100 text-yellow-700 dark:bg-yellow-900/20 dark:text-yellow-400">
                                      Premium
                                    </Badge>
                                  </div>
                              ...
                              <div className="text-center">
                                <p className="text-slate-600 dark:text-slate-400 mb-4">
                                  Enjoying Dream Homes? Your premium membership gives you access to exclusive
                                  features!
                                </p>
