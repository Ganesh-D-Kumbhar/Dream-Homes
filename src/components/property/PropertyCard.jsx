          ...
          <div className="absolute top-4 right-4 flex flex-col gap-2">
            <motion.button
              ...
              className={`p-3 rounded-full backdrop-blur-md shadow-lg transition-all duration-300 ${
                isLiked ? "bg-red-500 text-white" : "bg-white/90 hover:bg-white text-slate-700 hover:text-red-500"
              }`}
            >
            ...
            {/* <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              className="p-3 rounded-full bg-white/90 hover:bg-white text-slate-700 hover:text-gold-600 backdrop-blur-md shadow-lg transition-all duration-300 opacity-0 group-hover:opacity-100"
            >
