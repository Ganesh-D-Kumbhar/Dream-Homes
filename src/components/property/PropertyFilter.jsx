...
//                 className="pl-12 h-12 text-lg border-0 bg-slate-50 dark:bg-slate-700 focus:ring-2 focus:ring-gold-400"
//               />
//             </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <Button
                  variant="outline"
                  onClick={() => setIsExpanded(!isExpanded)}
                  className="h-9 sm:h-10 lg:h-12 px-3 sm:px-4 lg:px-6 border-slate-200 hover:border-amber-400 hover:text-amber-600 dark:border-slate-600 dark:hover:border-amber-400 relative flex-1 sm:flex-none text-xs sm:text-sm lg:text-base"
                >
          ...
          {isExpanded && (
            ...
            >
              <div className="p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-slate-800 dark:text-white mb-2 sm:mb-3 flex items-center">
                    <DollarSign className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-amber-500" />
                    Price Range
                  </h3>
